...
import 'package:farmmobile/app/modules/home/widgets/report_card.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(() {
          ...
          var percent = (completedTasks / createdTasks * 100).toStringAsFixed(2);
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildStatus(Color.fromARGB(255, 22, 22, 22),
                        completedTasks, 'Harvested'),
                    _buildStatus(Color.fromARGB(255, 22, 22, 22),
                        createdTasks, 'Planted'),
                  ],
                ),
              ),
